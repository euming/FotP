"""Populate FotP-SmartLists children from YAML."""
import yaml, subprocess, sys

PROJECT = "FotP-SmartLists"
BASE = "smartlist/execution-plan/fotp-smartlists/10-children"
...
data = yaml.safe_load(open("docs/fotp-smartlists-plan.yaml"))
